...
ARG RESTY_CONFIG_OPTIONS="\
    --add-module=/temp/nginx-aws-auth-module \
    --with-compat \
    --with-file-aio \
...
RUN apk add --no-cache --virtual .build-deps \
    ...
    && cd /tmp \
    && curl -fsL https://github.com/kaltura/nginx-aws-auth-module/archive/${AWS_AUTH_MODULE_VERSION}.tar.gz -o nginx-aws-module.tar.gz \
    && tar -xvf nginx-aws-auth-module.tar.gz \
